          ...
          <div class="sales-board-line">
              ...
              <div class="sales-board-line-right">
                  <v-selection :selections="districts" 
                   @on-change="onParamChange('buyCity', $event)"></v-chooser>></v-selection>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
...
export default {
  ...
  methods:{
    ...
    getPrice(){
      ...
      .then((res) => {
          console.log(res.data.getPrice,"ddd")
        this.price = res.data.getPrice.amountb*this.buyNum
      })
    },
    showPayDialog(){
