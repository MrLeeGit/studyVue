  ...
  <div class="sales-board">
      ...
      <div class="sales-board-form">
          ...
          <div class="sales-board-line">
              ...
              <div class="sales-board-line-right">
                <v-selection :selections="tradeLists" @on-change="onParamChange('tradeList', $event)"></v-selection>
              </div>
          </div>
          <div class="sales-board-line">
              <div class="sales-board-line-left">
...
export default {
  ...
  methods:{
    ...
    getPrice(){
      ...
      let reqParams = {
        ...
        tradeList: this.tradeList.value,
        period: this.period.value,
        version: buyVersionsArray.join(',')
      }
      this.$http.get('http://localhost:8080/db.json', reqParams)
      .then((res) => {
        this.price = res.data.getPrice.amountd*this.buyNum
      })
    },
    showPayDialog(){
  ...
  mounted(){
    this.buyNum = 1
    this.tradeList = this.tradeLists[0]
